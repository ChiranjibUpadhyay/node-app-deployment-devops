...
app.post('/', [
  check('username').equals(process.env.username),
  check('password').equals(process.env.password),
], (req, res) => {
...
/*app.post('/',function(req,res){
  ...
  req.check('username','Invalid username').equals(process.env.username);
  req.check('password','Invalid password').equals(process.env.password);
...
app.listen(process.env.app_port,function(){
  console.log('Server started...You are listening on port ',process.env.app_port);
})
